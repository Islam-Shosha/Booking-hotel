...
public class key_lock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonCheck = findViewById(R.id.check_password);
        ...
        buttonTimer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(key_lock.this, DowntimeActivity.class);
                intent.putExtra("appName",extras.getString("appName"));
